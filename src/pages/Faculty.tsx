    ...
    return (
        <Container className="mt-5 faculty-container">
            ...
            <div className="carousel">
                ...
                >
                    {faculty.map(mem => (
                        <div
                            key={mem.id}
                            className={`card-wrapper ${hoveredId === mem.id ? 'card-wrapper--hovered' :
                                hoveredId !== null && hoveredId !== mem.id ? 'card-wrapper--inactive' : ''
                                }`}
            ...
            <Modal show={showModal} onHide={handleCloseModal} centered size="lg">
                ...
                <Modal.Body>{selectedMember?.body}</Modal.Body>
                <Modal.Footer>
